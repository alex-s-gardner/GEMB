...
switch densification_coeffs_M01
    % ------------------------ Antarctic -------------------------
    % ERA5 new albedo_method="GardnerSharp", shortwave_subsurface_absorption=0
    ...
    % ERA5 new albedo_method="BrunLefebre", shortwave_subsurface_absorption=1
    ...
    % ------------------------- Greenland ------------------------
    % ERA5 new albedo_method="GardnerSharp", shortwave_subsurface_absorption=0, bare ice
    ...
    %  ismember(albedo_method,["GreuellKonzelmann","Bougamont2005"]) && shortwave_subsurface_absorption==true
