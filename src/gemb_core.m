function [T, dz, d, W, re, gdn, gsp, a, a_diffuse, EC, M_surf, sw_net, shf, ...
    ...
    swf = shortwave(dz, d, re, dsw, dsw_diffuse, a(1), a_diffuse(1), ...
        S.density_ice,  S.albedo_method, S.sw_absorption_method);
    ...
    [T, shf, lhf, EC, ulw] = ...
        ...
        S.density_ice, LP.Vz, LP.Tz, S.emissivity, S.ulw_delta, ...
    ...
    [T, dz, d, W, re, gdn, gsp, a, a_diffuse, Ra] = ...
        ...
        V, S.density_ice, LP.T_air_mean, S.column_dzmin, LP.P_mean, LP.V_mean, ...
    ...
    [T, dz, d, W, re, gdn, gsp, a, a_diffuse, M, M_surf, R, F] = ...
        melt(T, dz, d, W, re, gdn, gsp, a, a_diffuse, Ra, S.density_ice, verbose);
    ...
    [dz, d] = densification(T, dz, d, re, dt, S.density_ice, LP.T_air_mean, ...
        LP.P_mean, S.albedo_desnity_threshold, S.albedo_method, ...
