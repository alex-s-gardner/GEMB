classdef test_melt < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_cold_dry_snow_no_change(tcase)
            ...
            [t_out, dz_out, d_out, w_out, ~, ~, ~, ~, ~, m_tot, ~, r_tot, f_tot] = ...
                melt(tcase.t_vec, tcase.dz, tcase.d, tcase.w, tcase.re, ...
                tcase.gdn, tcase.gsp, tcase.a, tcase.a_diffuse, ...
                tcase.ra, tcase.rho_ice, tcase.verbose);
        ...
        function test_runoff_on_ice(tcase)
            ...
            tcase.d(2) = tcase.rho_ice; % Impermeable layer below
        ...
        function test_rain_accounting(tcase)
            ...
            % melt.m subtracts Ra from the *reported* Total Melt (M_total) 
            ...
            [~, ~, ~, ~, ~, ~, ~, ~, ~, m_tot_rain, ~, ~, ~] = ...
                melt(tcase.t_vec, tcase.dz, tcase.d, tcase.w, tcase.re, ...
                tcase.gdn, tcase.gsp, tcase.a, tcase.a_diffuse, ...
                rain_input, tcase.rho_ice, tcase.verbose);
