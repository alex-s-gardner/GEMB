...
2. **Define Model Parameters:** Use [`model_initialize_parameters`](docs/model_initialize_parameters_documentation.md) to set model parameters which densification model is used.
