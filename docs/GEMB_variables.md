...
| albedo\_diffuse                        | fraction          |                                                                                                                                                  |
| albedo\_dry\_snow\_t0                | days              | Time scale for dry snow from Bougamont et al., 2005.                                                                                             |
...
| albedo\_K                              |                   | Tuned constant K in Eq 5b of Bougamont et al., 2005.                                                                                             |
| albedo\_method                         | string            | Scheme: "GardnerSharp", "GreuellKonzelmann", etc.                                                                                                |
| albedo\_snow                           | fraction          | Albedo for fresh snow (0.5-0.95).                                                                                                                |
| albedo\_surface                        | fraction          |                                                                                                                                                  |
| albedo\_wet\_snow\_t0                | days              | Time scale for wet snow from Bougamont et al., 2005.                                                                                             |
| black\_carbon\_ice                    | ppm               | black carbon concentration in ice                                                                                                                |
| black\_carbon\_snow                   | ppm               | black carbon concentration in snow                                                                                                               |
| cloud\_fraction                        | fraction          | Cloud fraction (0-1) for GreuellKonzelmann method.                                                                                               |
| cloud\_optical\_thickness             |                   |                                                                                                                                                  |
| column\_dzmax                          | m                 | Maximum allowable grid spacing. See Figure 1 of Gardner et al., 2023                                                                             |
| column\_dzmin                          | m                 | Minimum allowable grid spacing. See Figure 1 of Gardner et al., 2023                                                                             |
| column\_dztop                          | m                 | Initial surface grid spacing. See Figure 1 of Gardner et al., 2023                                                                               |
| column\_zmax                           | m                 | Maximum total column depth. See Figure 1 of Gardner et al., 2023                                                                                 |
| column\_zmin                           | m                 | Minimum total column depth. See Figure 1 of Gardner et al., 2023                                                                                 |
| column\_ztop                           | m                 | Depth of constant grid spacing at the surface. See Figure 1 of Gardner et al., 2023.                                                             |
| column\_zy                             | m                 | Grid stretching factor for lower layers. See Figure 1 of Gardner et al., 2023                                                                    |
| compaction\_melt                       | m                 | Compaction due to melt.                                                                                                                          |
